...
class Main:
    def __init__(self) -> None:
        ...
        self.ranglist = RangListState(self.screen, BACKGROUND_COLOR)
    ...
    def mainloop(self) -> None:
        ...
        while True:
            ...
            elif State.current_state == ScreenState.RANGLIST:
                self.ranglist.draw_elements()
            ...
            for event in pygame.event.get():
                ...
                if State.current_state == ScreenState.MENU:
                    ...
                    self.ranglist.handle_events(event)
